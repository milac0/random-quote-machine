...
const App = () => {
  ...
  useEffect (() => {
    const fetchData = async () => {
      const url = 'https://gist.githubusercontent.com/shreyasminocha/7d5dedafc1fe158f82563c1223855177/raw/325d51aca7165b2498971afcff9bed286a52dc0e/quotes.json'
      try {
  ...
  return (
    ...
    <Typography variant="h4">{quote.quote}</Typography>
      <Typography variant="h5" align="right">-{quote.author}</Typography>
      ...
      <Link href="http://facebook.com">
        ...
        <Grid item>
        <Button className="button" color="primary" variant="contained" onClick={handleClick}>New Quote</Button>
        </Grid>
      </Grid>
     </Paper>
    </Fragment>
